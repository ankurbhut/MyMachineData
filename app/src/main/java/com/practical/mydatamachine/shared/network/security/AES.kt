package com.practical.mydatamachine.shared.network.security
...
object AES {
    ...
    fun encode(string: String, Key: String): String? {
        try {
            ...
            return com.practical.mydatamachine.shared.network.security.JavaUtil.bytesToHex(cipher.doFinal(stringToEncode))
        } catch (e: Exception) {
            e.printStackTrace()
        }
        return ""
