...
import com.practical.mydatamachine.shared.extension.getThemeAttrColorStateList
import com.practical.mydatamachine.shared.extension.getThemeColor
    ...
    private fun createMaterialShapeDrawable(bottomSheet: View): MaterialShapeDrawable {
        ...
        newMaterialShapeDrawable.fillColor = if (overrideBackgroundColor) {
            requireContext().getThemeAttrColorStateList(
                com.google.android.material.R.attr.colorOnSurface, R.style.Theme_Givvy_Ludo
            )
        } else {
