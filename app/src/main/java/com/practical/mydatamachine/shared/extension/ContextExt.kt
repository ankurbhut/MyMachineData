...
import com.practical.mydatamachine.databinding.DialogGeneralBinding
...
fun Context.createAlertDialog(
    ...
    val dialog = MaterialAlertDialogBuilder(this)
        .setView(customView ?: binding.root)
    ...
    if (customView == null) {
        with(binding) {
            ...
            if (buttonPositive.isVisible && buttonNegative.isVisible) {
                buttonPositive.letterSpacing = 0.10f
                buttonNegative.letterSpacing = 0.10f
            } else {
                buttonPositive.letterSpacing = 0.45f
                buttonNegative.letterSpacing = 0.45f
            }
        }
    }
    return dialog
...
fun Context.openPermissions(activityLauncher: com.practical.mydatamachine.shared.base.BetterActivityResult<Intent, ActivityResult>?, onPermissionGranted: (Boolean) -> Unit) {
    try {
...
fun Context.checkAndEnableNotificationReadSetting(
    activityLauncher: com.practical.mydatamachine.shared.base.BetterActivityResult<Intent, ActivityResult>?, onPermissionGranted: (Boolean) -> Unit
) {
