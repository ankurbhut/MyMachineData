...
object ViewUtil {
    ...
    fun Context.getStatusBarHeight(): Int {
        ...
        return if (resourceId > 0) {
            ...
            // Fallback value if status bar height cannot be found
    ...
    @JvmStatic
    fun getTimeAgo(view: View, time: Long, format: String?): String? {
        return when {
    ...
    private fun getSharingMessage(context: Context, roomCode: String, link: String): CharSequence {
        return ("Let`s do mining together in ${context.getString(R.string.app_name)}! Use link or code to join room:\n$link\n\nCode : $roomCode")
    }
